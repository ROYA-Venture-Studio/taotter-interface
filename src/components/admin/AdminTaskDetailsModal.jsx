...
import styles from './AdminTaskDetailsModal.module.css';

const CloseIcon = () => (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1.04321 1.04364C1.43373 0.653391 2.06682 0.65329 2.45728 1.04364L6.99927 5.58563L11.5413 1.04364L11.6165 0.975281C12.0092 0.654799 12.5891 0.677555 12.9553 1.04364C13.3215 1.40981 13.3442 1.98973 13.0237 2.38251L12.9553 2.4577L8.41333 6.99969L12.9553 11.5417L13.0237 11.6169C13.3442 12.0097 13.3215 12.5905 12.9553 12.9567C12.5892 13.3228 12.0092 13.3456 11.6165 13.0251L11.5413 12.9567L6.99927 8.41475L2.45728 12.9567L2.38207 13.0251C1.98929 13.3456 1.40937 13.3228 1.04321 12.9567C0.677041 12.5905 0.654285 12.0106 0.974767 11.6178L1.04321 11.5426L5.58521 7.00069L1.04321 2.45871L0.974767 2.38349C0.654285 1.99071 0.677041 1.41079 1.04321 1.04464L1.04321 1.04364Z" fill="currentColor"/>
    </svg>
);

export default function AdminTaskDetailsModal({
    open,
    onClose,
    task,
    columns,
    ...
    const handleDelete = async () => {
        ...
        if (typeof onDeleteTask === "function") {
            ...
            console.warn("onDeleteTask is not a function or not passed to AdminTaskDetailsModal");
        }
    };
